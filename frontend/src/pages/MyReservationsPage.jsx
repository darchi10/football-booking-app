    ...
    return (
        <div>
            ...
            <div className='container mx-auto p-8'>
                <h1 className='text-3xl font-bold mb-6 text-center'>{user.username}: Reservations</h1>
                {reservations.length === 0 ? (
                    <p className='text-center text-gray-600'>You have no active reservations.</p>
                ) : (
                    <>
                        <div className='pl-6 mt-4'>
                            <input
                                ...
                                className="mr-1"
                            />
                            <label htmlFor="showAll" className="text-gray-700">Show old reservations</label>
                        </div>
